 ...
 */
class todo extends \AppBundle\Entity\todo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\todo' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\todo' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\todo' . "\0" . 'category', '' . "\0" . 'AppBundle\\Entity\\todo' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\todo' . "\0" . 'priority', '' . "\0" . 'AppBundle\\Entity\\todo' . "\0" . 'dueDate', '' . "\0" . 'AppBundle\\Entity\\todo' . "\0" . 'createDate'];
        }
